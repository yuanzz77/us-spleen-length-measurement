...
class unet(nn.Module):
    ...
    def __init__(self):
        ...
        self.fcn1 = nn.Linear(in_features=1024 * 19 * 27, out_features=256)
        ...
        self.con6_1 = nn.Conv2d(1024, 512, 3, padding=1)
        self.con6_2 = nn.Conv2d(512, 512, 3, padding=1)
        self.bn11 = nn.BatchNorm2d(512)
        self.bn12 = nn.BatchNorm2d(512)

        self.up2 = nn.ConvTranspose2d(512, 256, kernel_size=3, stride = 2)
        self.con7_1 = nn.Conv2d(512, 256, 3, padding=1)
        self.con7_2 = nn.Conv2d(256, 256, 3, padding=1)
        self.bn13 = nn.BatchNorm2d(256)
        self.bn14 = nn.BatchNorm2d(256)

        self.up3 = nn.ConvTranspose2d(256, 128, kernel_size=3, stride = 2)
        self.con8_1 = nn.Conv2d(256, 128, 3, padding=1)
        self.con8_2 = nn.Conv2d(128, 128, 3, padding=1)
        self.bn15 = nn.BatchNorm2d(128)
        self.bn16 = nn.BatchNorm2d(128)

        self.up4 = nn.ConvTranspose2d(128, 64, kernel_size=3, stride = 2)
        self.con9_1 = nn.Conv2d(128, 64, 3, padding=1)
        self.con9_2 = nn.Conv2d(64, 64, 3, padding=1)
        self.bn17 = nn.BatchNorm2d(64)
        self.bn18 = nn.BatchNorm2d(64)

        self.con10 = nn.Conv2d(64, 1, 1)
    ...
    def forward(self, image):
        ...
        fc1 = F.relu(self.bn_fcn1(self.fcn1(fp5.view(-1, fp5.shape[1] * fp5.shape[2] * fp5.shape[3]))))
        ...
        fp6 = F.relu(self.bn12(self.con6_2(F.relu(self.bn11(self.con6_1(torch.cat((fp4, up1), 1)))))))

        up2 = self.up2(fp6)
        fp7 = F.relu(self.bn14(self.con7_2(F.relu(self.bn13(self.con7_1(torch.cat((fp3, up2), 1)))))))

        up3 = self.up3(fp7)
        fp8 = F.relu(self.bn16(self.con8_2(F.relu(self.bn15(self.con8_1(torch.cat((fp2, up3), 1)))))))

        up4 = self.up4(fp8)
        fp9 = F.relu(self.bn18(self.con9_2(F.relu(self.bn17(self.con9_1(torch.cat((fp1, up4), 1)))))))

        output = torch.sigmoid(self.con10(fp9))
